...
export class PickerColumnCmp {
    ...
    render() {
        ...
        results.push(h("div", { class: "picker-opts", style: { maxWidth: col.optionsWidth } }, options.map((o, index) => h("button", { class: { 'picker-opt': true, 'picker-opt-disabled': !!o.disabled }, "disable-activated": true, onClick: event => this.optClick(event, index) }, o.text))));
        if (col.suffix) {
